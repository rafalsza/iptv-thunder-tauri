...
interface FavoriteSeriesCategoryCardProps {
...
const FavoriteSeriesCategoryCard: React.FC<FavoriteSeriesCategoryCardProps> = ({
  category,
  categoryIndex,
  selectedCategory,
  onSelect,
  ...
  return (
    <div
      key={category.id}
      data-tv-focusable
      data-tv-group="favorite-series-categories"
