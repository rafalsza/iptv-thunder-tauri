...
interface SeriesCategoryCardProps {
...
const SeriesCategoryCard: React.FC<SeriesCategoryCardProps> = ({
  category,
  categoryIndex,
  selectedCategory,
  isCategoryFavorite,
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={(e) => {
              ...
              onToggleFavorite(e, categoryId, category.title);
            }}
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="border-b dark:border-slate-700 border-gray-300 p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-bold dark:text-white text-slate-900">{t('seriesCategories')}</h1>
        </div>
