    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p>Ładowanie ulubionych kategorii filmów...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 overflow-auto">
      ...
      <div className="sticky top-0 bg-slate-900 bg-opacity-95 backdrop-blur-sm p-6 pb-4 z-10 border-b border-slate-800">
        <h1 className="text-2xl font-bold text-white mb-2">Ulubione kategorie filmów</h1>
        <p className="text-slate-400">
          Twoje ulubione kategorie filmów ({favoriteCategories.length})
        </p>
        {search && (
